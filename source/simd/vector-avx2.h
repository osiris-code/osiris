/****************************************************************************************/
/* SIMD utilites.                                                                       */
/* Definitions for Intel AVX2                                                           */
/****************************************************************************************/

#ifndef _VECTOR_AVX2_H
#define _VECTOR_AVX2_H
...
/*
* Defines replacements for fused multiply-add (FMA) operations. These can be used for two
* purposes:
*  i) Use of this module in systems supporting AVX2 but the not the FMA extensions (possible
*     but not likely)
*  ii) Benchmarking against serial Fortran code and other SIMD implementations (the FMA
*     operations have different roundoff properties from the non-fused counterparts)
*
...
/* End of definitions for Intel AVX2 */
